...
layout: page
title:
permalink: /people/borna-khodabandeh/
nav: false
---
...
<div id="profile-page">
  <header class="profile-header">
    <div class="profile-title">
      <h1>Borna Khodabandeh</h1>
      <p class="subtitle">BSc Student · Sharif University of Technology · Electrical Engineering</p>
    </div>
    <div class="profile-photo">
      {% include figure.liquid path="assets/img/logo.png" alt="Borna Khodabandeh" class="img-fluid z-depth-1 rounded" loading="lazy" cache_bust=true %}
    </div>
  </header>
  ...
  <section class="profile-grid">
    <aside class="profile-aside">
      ...
      <div class="panel">
        ...
        <p><a class="btn btn-sm" href="mailto:borna710kh@gmail.com">Email</a></p>
        <div class="links">
